<template>
    <div class="flex items-center">
        ...
        <div class="time-component-container flex items-center justify-center flex-1 bg-gray-700 rounded">
            ...
            <div class="decrease flex-1 px-2 py-3 select-none" @click="decreaseHour">
            ...
            <div class="increase flex-1 px-2 py-3 select-none" @click="increaseHour">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20px" height="20px">
        ...
        <div class="time-component-container flex items-center justify-center flex-1 bg-gray-700 rounded">
            ...
            <div class="decrease flex-1 px-2 py-3 select-none" @click="decreaseMinute">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20px" height="20px">
                    <path d="M0 0h24v24H0V0z" fill="none" opacity=".87" />
                    <path d="M17.51 3.87L15.73 2.1 5.84 12l9.9 9.9 1.77-1.77L9.38 12l8.13-8.13z" />
                </svg>
            ...
            <div class="increase flex-1 px-2 py-3 select-none" @click="increaseMinute">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20px" height="20px">
                    <path d="M24 24H0V0h24v24z" fill="none" opacity=".87" />
                    <path d="M6.49 20.13l1.77 1.77 9.9-9.9-9.9-9.9-1.77 1.77L14.62 12l-8.13 8.13z" />
                </svg>
